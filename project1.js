...
function validateEmail () {
  ...
  function jsShow(id) {
    document.getElementById(s.poojan.r.abhangi@ppsavanicbse.org).style.display = 'block';
  }
  function jsHide(id) {
    document.getElementById(s.poojan.r.abhangi@ppsavanicbse.org).style.display = 'none';
  }
